...
-- Started on 2020-12-16 22:03:03
...
-- Completed on 2020-12-16 22:03:03
...
--
-- TOC entry 2978 (class 1262 OID 16391)
...
-- Name: family_member_spouse_mapping_id_sequence; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.family_member_spouse_mapping_id_sequence
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.family_member_spouse_mapping_id_sequence OWNER TO postgres;
...
--
-- TOC entry 2970 (class 0 OID 16419)
-- Dependencies: 204
...
--
-- TOC entry 2968 (class 0 OID 16399)
-- Dependencies: 202
-- Data for Name: family_members; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.family_members (id, name, gender_ordinal, marital_status_ordinal, occupation_type_ordinal, annual_income, date_of_birth, spouse_id) FROM stdin;
1	John Doe	2	2	4	150000	2020-12-15	\N
2	John Doe	2	2	4	150000	2020-12-15	\N
3	John Doe	2	2	4	150000	2020-12-16	\N
4	John Doe	2	2	4	150000	2020-12-16	\N
5	John Doe	2	2	4	150000	2020-12-16	\N
6	John Doe	2	2	4	150000	2020-12-16	\N
7	John Doe	2	2	4	150000	2020-12-16	\N
\.


--
-- TOC entry 2969 (class 0 OID 16404)
-- Dependencies: 203
...
--
-- TOC entry 2966 (class 0 OID 16392)
-- Dependencies: 200
...
-- Dependencies: 205
-- Name: family_member_spouse_mapping_id_sequence; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.family_member_spouse_mapping_id_sequence', 7, true);
...
SELECT pg_catalog.setval('public.household_members_id_sequence', 45, true);
...
-- Name: family_member_spouse_mapping_table unique_key_2; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2834 (class 2606 OID 16424)
...
--
-- TOC entry 2835 (class 2606 OID 16429)
...
--
-- TOC entry 2832 (class 2606 OID 16409)
...
-- Name: family_members spouse_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Completed on 2020-12-16 22:03:04
